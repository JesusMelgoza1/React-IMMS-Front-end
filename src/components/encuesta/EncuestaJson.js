export const encuesta1 = [{
    encuesta: 'Guía de Referencia I EJEMPLO DE CUESTIONARIO PARA IDENTIFICAR A LOS TRABAJADORES QUE FUERON SUJETOS A ACONTECIMIENTOS TRAUMÁTICOS SEVEROS',
    preguntas: [
        {
        ...
        {
            'pregunta':'¿Ha tenido la impresión de que su vida se va a acortar, que va a morir antes que otras personas o que tiene un futuro limitado?',
            'respuesta':['SI','NO'],
            'ponderacion':['1','2'],
            'seccion':'III.- Esfuerzo por evitar circunstancias parecidas o asociadas al acontecimiento (durante el último mes)'
        },
...
export const encuesta2 = [{
    encuesta: 'Guia de Referencia II IDENTIFICACION Y ANALISIS DE LOS FACTORES DE RIESGO PSICOSOCIAL',
    preguntas: [
        {
            'pregunta':'¿Mi trabajo me exige hacer mucho esfuerzo fisico?',
...
export const encuesta3 = [{
    encuesta: 'Guía de Referencia III IDENTIFICACIÓN Y ANÁLISIS DE LOS FACTORES DE RIESGO PSICOSOCIAL Y EVALUACIÓN DEL ENTORNO ORGANIZACIONAL EN LOS CENTROS DE TRABAJO',
    preguntas: [
        {
